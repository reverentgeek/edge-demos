...
using node_aspnet_benchmark.Services;
using ServiceStack;
...
[assembly: WebActivator.PreApplicationStartMethod(typeof(node_aspnet_benchmark.App_Start.AppHost), "Start")]
...
namespace node_aspnet_benchmark.App_Start
{
	...
	{		
		public AppHost() //Tell ServiceStack the name and where to find your web services
			: base("StarterTemplate ASP.NET Host", typeof(CalculatorService).Assembly) { }
